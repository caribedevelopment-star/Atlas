...
export async function POST(request: Request) {
  try {
    ...
    catch (error) { console.error('Cania provider error:',error); return NextResponse.json({ reply: localSommelier(message,body.wines??[]), warning:'Cania está usando recomendaciones locales porque el proveedor de IA no está disponible.' }); }
