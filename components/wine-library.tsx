...
export function WineLibrary() {
  ...
  return <main className="min-h-screen bg-zinc-950 pb-28 text-zinc-100 selection:bg-rose-500/30">
    ...
    <WineDetailDialog wine={library.selectedWine} editable={library.selectedWine?.user_id===library.userId} onClose={() => library.setSelectedWine(null)} onFavorite={(wine) => void library.toggleFavorite(wine)} onSave={(wine,changes)=>library.editWine(wine,changes)} />
